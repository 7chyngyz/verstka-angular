...
@Component({
  ...
  template: `
  <!-- block-1 -->
   <div class="flex flex-col ml-[120px] justify-center">
  ...
  <!-- block-3 -->
  <div class=" flex gap-[220px] py-[30px] border-b">
    <div class="flex flex-col">
  ...
  <div class="flex justify-between py-[30px] border-b">
    ...
    <div class="flex items-center gap-10">
      <img class="w-[150px] h-[120px] border rounded-[7px]" src="/assets/zoro1.jpg" alt="zoro">
      <img class="w-[150px] h-[120px] border rounded-[7px]" src="/assets/zoro2.jpg" alt="zoro">
      <img class="w-[150px] h-[120px] border rounded-[7px]" src="/assets/zoro3.jpg" alt="zoro">
    </div>
  </div>
   <!-- block-5 -->
   <div class=" flex gap-[250px] py-[30px] border-b">
    <div class="flex flex-col">
      <h1 class="text-[20px] font-semibold">Tranparent sidebar</h1>
      <p class="text-[20px] font-semibold opacity-50">Select or customize your UI theme.</p>
    </div>
    <div>
   ...
   <!-- block-6 -->
   <div class=" flex gap-[230px] py-[30px] border-b">
    <div class="flex flex-col">
    ...
    <div>
      <select class="w-[300px] border-2 px-[20px] h-[50px] rounded-[10px] text-[20px] font-medium outline-none">
   ...
   <!-- block-6 -->
   <div class=" flex gap-[420px] py-[30px] border-b">
    <div class="flex flex-col">
  ...
  <!-- block-7 -->
   <div class="flex justify-end mb-[50px] gap-[20px] py-[30px]">
